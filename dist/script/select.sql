SELECT
	...
	DeleteFlag
FROM
	Visit where PatientID = '4683927' and PIDAssigningAuthority ='MA27WJX03.RIS.CT';
...
SELECT
	...
	GroupID
FROM
	ObservationRequest where ObservationUID = 'AF183663-BE75-451F-A5B1-59F72F2C7C4D';
...
SELECT
	...
	DeleteFlag
FROM
	ExamResult where ObservationUID = 'AF183663-BE75-451F-A5B1-59F72F2C7C4D' and DeleteFlag = 0;
...
SELECT
	...
	Status
FROM
	PatientIndex where PatientID ='8019653' and PIDAssigningAuthority ='MA27WJX03.RIS.CT';
...
SELECT
	...
	FolderFlag
FROM
	Document where BusinessID ='AF183663-BE75-451F-A5B1-59F72F2C7C4D' and DeleteFlag = 0;

SELECT
	*
FROM
	DocumentInservice where  FileUID in ('653742E1-59B0-47AF-82E2-48A7E6992BBB','FC3A8C23-E355-4D4D-B264-D40EFFB84DA5')
