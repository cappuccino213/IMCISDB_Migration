SELECT
	...
	DeleteFlag
FROM
	Visit where PatientID in (select patientid from PatientIndex where PIDAssigningAuthority LIKE 'local.RIS.%');
...
SELECT
	...
	GroupID
FROM
	ObservationRequest where PatientID in (select patientid from PatientIndex where PIDAssigningAuthority LIKE 'local.RIS.%') and DeleteFlag=0;
...
SELECT
	...
	DeleteFlag
FROM
	ExamResult where ObservationUID in (select observationuid from v_exam where PIDAssigningAuthority LIKE 'local.RIS.%');
...
SELECT
	...
	Status
FROM
	PatientIndex where PIDAssigningAuthority LIKE 'local.RIS.%';
